//openGUI is free open-source GUI library for Processing. Licensed under General Public License (GPL), created by George Bochev on 30 Jan 2014.
//Notes : you must add void keyReleased() to your main code, and then put there all textbox object's functions keyReleased();
//colors
